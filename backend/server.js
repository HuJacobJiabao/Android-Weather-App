...
// API keys
const GOOGLE_MAPS_API_KEY = 'AIzaSyBjJ8FLCH9dtjZolJIcwC0tGZXRZRBCt_k';
const TOMORROW_API_KEY = 'ngeLdzyuh4qE3L8CcRQLEgRrUQKPpqeO';
...
app.post('/api/favorites', async (req, res) => {
  try {
    ...
    const result = await collection.insertOne(newFavorite); // Insert the new favorite into the collection
    res.status(201).json({id: result.insertedId, message: 'City saved successfully' });
  } catch (error) {
